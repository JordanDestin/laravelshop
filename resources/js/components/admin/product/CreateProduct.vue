...
<template>
     <form >
        ...
        <div>
            ...
            <input v-model="Products.name" id="post-title" type="text" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
        ...
        <div class="mt-4">
            ...
            <textarea v-model="post.description" id="post-content" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
            <!-- <div class="text-red-600 mt-1">
                {{ errors.content }}
            </div>
            <div class="text-red-600 mt-1">
