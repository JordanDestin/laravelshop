        ...
        <table class="table-auto w-full divide-y divide-slate-200" >
          ...
          <tbody class="text-sm" v-for="product in products.data" :key="product.id">
            <tr>
              ...
              <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                <div class="text-left font-medium text-emerald-500">{{ product.quantity_product }}</div>
              </td>
              <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                <div class="text-left font-medium text-emerald-500">{{ product.price }}</div>
              </td>
              <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                <div class="text-left font-medium text-emerald-500">{{ product.active }}</div>
              </td>
              <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                <div class="text-left font-medium text-emerald-500">{{ product.tendance }}</div>
              </td>
              <td>
                <button
                  type="button"
